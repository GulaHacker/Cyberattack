...
<html lang="en">
  ...
  <body>
    <div class="container" style="padding-top:100px" id="blur">
        <form>
            ...
            <button type="button" id="submit" class="btn btn-primary" onsubmit="toggle()" >Submit</button>
        </form>
</div>
    ...
    <script type="text/javascript">
        function toggle(){
            var blur = documnet.getElemnetById('blur');
